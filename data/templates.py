...
stanford_dogs_template = [
    lambda c: f'a photo of {" ".join(c.split("-")[1:])}, a type of dog',
]

oxford_flowers102_template = [
    lambda c: f'a photo of {c}, a type of flower',
]

oxford_iiit_pet_template = [
    lambda c: f'a photo of a pet {c}',
]

cassava_template = [
    lambda c: f'a photo of a leaf of a healthy Cassava plant' if c == 'healthy' else f'a photo of a leaf of a Cassava plant with {c} disease',
]
colorectal_histology_template = [
    lambda c: f'a photo of {c} texture in colorectal cancer histology',
]

places365_small_template = [
    lambda c: f'a photo of a {" ".join(c.split("/").reverse())}.',
    lambda c: f'a photo of the {" ".join(c.split("/").reverse())}.',
]

dataset_to_template = {
    'cars196': cars_template,
    ...
    'imagenet2012': imagenet_template,
    'resisc45': resisc45_template,
    'stl10': stl10_template,
    'sun397': sun397_template,
    'svhn_cropped': svhn_template,
    'imagenette' : imagenet_template, 
    'stanford_dogs': stanford_dogs_template,
    'oxford_flowers102': oxford_flowers102_template,
    'oxford_iiit_pet': oxford_iiit_pet_template,
    'cassava': cassava_template,
    'colorectal_histology': colorectal_histology_template,
    'places365_small': places365_small_template, 
    'caltech101': sun397_template
}
